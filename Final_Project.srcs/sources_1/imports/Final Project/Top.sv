...
///////////////////////////////////////////////////////////////////////////////
// Description:
// Top File for a Simplistic Processing Engine
//
// References:
...
module top ();
    ...
    always @(Databus) begin // this block checks to make certain the proper data is in the memory.
        if (Databus[31:0] == 32'hff000000) begin // we are about to execute the stop
            ...
            if (U3.InternalReg[1] == 256'h00360048007e0090007e009000fc007e012000a200d800c600d8005a005a006c)
